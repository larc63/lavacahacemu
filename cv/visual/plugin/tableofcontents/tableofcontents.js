...
var RevealTableOfContents = window.RevealTableOfContents || (function () {
    ...
    var options = {
        ...
        title: 'Table of Contents', // Title for the TOC slide
        position: 2,                // Position of the TOC slide (e.g., after the title slide)
        titleTagSelector: 'h1, h2, h3, h4, h5, h6', // Which headings to include
        ignoreFirstSlide: true,     // Ignore the title slide's title
        fadeInElements: false       // Fade in TOC elements incrementally
    };
